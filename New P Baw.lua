...
local window = library:AddWindow("C4EGOITS | Private - Hello "..display, {
...
infoTab:Show()
infoTab:AddLabel("made by C4").TextSize = 20
infoTab:AddLabel("")
local wLabel = infoTab:AddLabel("This script is made for P Baw")
wLabel.TextSize = 30
